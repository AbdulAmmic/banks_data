...
const ReconciliationsPage: React.FC = () => {
  ...
  const products = [
    { id: "1", name: "Product 1", category: "Category A", quantity: 100, actualQuantity: 98 },
    { id: "2", name: "Product 2", category: "Category B", quantity: 50, actualQuantity: 52 },
  ...
  const filteredProducts = products.filter(
    (product) =>
      ...
      product.actualQuantity.toString().includes(searchQuery)
  );
  ...
  return (
    <div className="flex h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-4 overflow-y-auto">
          <div className="flex justify-between mb-4">
            ...
            >
              <AiOutlineCheckCircle /> Reconcile Products
            </button>
          </div>
              ...
              <table className="min-w-full text-left text-sm text-gray-600 dark:text-gray-200">
                <thead className="bg-gray-200 dark:bg-gray-700">
                  <tr>
                    ...
                    <th className="py-3 px-6 font-medium">Expected Quantity</th>
                    <th className="py-3 px-6 font-medium">Actual Quantity</th>
                    <th className="py-3 px-6 font-medium">Discrepancy</th>
                  </tr>
                </thead>
                <tbody>
      ...
      {/* Sidenav for Reconciliation */}
      <Sidenav
        isOpen={isSidenavOpen}
        onClose={handleCloseSidenav}
        header="Reconcile Products"
        description="Review the discrepancies and confirm reconciliation."
        inputs={
          <>
            <div>
              ...
              <textarea
                placeholder="Add any notes regarding the reconciliation..."
        ...
        button={
          <button className="bg-amber-500 text-white px-3 py-2 rounded-md hover:bg-amber-600">
