...
const RestockProductsPage: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-4 overflow-y-auto">
          <div className="flex justify-between mb-4">
            ...
            >
              <AiOutlinePlusCircle /> Restock Products
            </button>
          </div>
              ...
              <table className="min-w-full text-left text-sm text-gray-600 dark:text-gray-200">
                <thead className="bg-gray-200 dark:bg-gray-700">
                  <tr>
                    ...
                    <th className="py-3 px-6 font-medium">Current Quantity</th>
                    <th className="py-3 px-6 font-medium">Restock Quantity</th>
                  </tr>
                </thead>
                <tbody>
      ...
      <Sidenav
        ...
        header="Restock Products"
        description="Add the quantities to be restocked for the selected products."
        inputs={
          <div>
            ...
            <textarea
              placeholder="Add any notes regarding the restock..."
